...
platforms_arr = ['AI', 'AR', 'AT', 'CI A', 'CI B', 'CI C', 'CI D', 'CI E', 'CI F', 'CI G', 'CI H', 'RA', 'FA-A', 'FA-B', 'FA-C', 'GI A', 'IND A', 'INT A', 'INT AC', 'INT B', 'KRM A', 'KAT AC', 'KIT A', 'KRI A', 'KRI B', 'KRI C', 'KRI D', 'KRI E', 'LID AC', 'LI AC', 'WAN BC', 'WAN-A', 'ITA', 'ITA AC', 'NO', 'RAA A', 'RAA B', 'RAA C', 'RAA D', 'RAA E', 'RAA F', 'RAA G', 'RAA H', 'RAA I', 'ZEL AC', 'SEL A', 'SUN A', 'SUN B', 'SUR AC', 'WA-A', 'TER AC', 'TIT A', 'VTA AC', 'WDA', 'WDI A', 'WDI B', 'WDI C', 'WDI DC', 'WDI E', 'WDI F', 'WDI G', 'WDI H', 'WDI-D', 'WNDRI AC', 'YAN-A', 'YAN-AC', 'YV A', 'YVO B', 'ZDA A', 'ZDA B', 'ZDA C', 'ZDA D', 'ZDA-E']

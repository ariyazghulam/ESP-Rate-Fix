...
model_type = st.sidebar.selectbox('Regression Model Method', ['Linear Regression','Decision Tree Regressor','Random Forest Regressor', 'KNeighbors Regressor'])
...
st.markdown('''
This program is able to select suitable pump and predict its run life. 
Input all the needed data in the left side of program: 
* Well Information
* Well Performance
* Completion Data
* Fluid Properties
...
st.sidebar.title('**Input Data for Pump Selection and Run Life Prediction**')
